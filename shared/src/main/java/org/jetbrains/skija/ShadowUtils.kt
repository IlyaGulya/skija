...
object ShadowUtils {
    ...
    fun drawShadow(
        ...
        _nDrawShadow(
            Native.getPtr(canvas), Native.getPtr(path), zPlaneParams.x, zPlaneParams.y, zPlaneParams.z,
            lightPos.x, lightPos.y, lightPos.z, lightRadius, ambientColor, spotColor, flags
        )
    }
    ...
    internal external fun _nDrawShadow(
        canvasPtr: Long,
        pathPtr: Long,
        zPlaneX: Float,
        zPlaneY: Float,
    ...
    internal external fun _nComputeTonalAmbientColor(ambientColor: Int, spotColor: Int): Int

    internal external fun _nComputeTonalSpotColor(ambientColor: Int, spotColor: Int): Int
